...
<?php echo $postDate2; ?></time> | <span class="byline fn author"><?php the_author_posts_link(); ?></span> | <a href="mailto:<?php the_author_email(); ?>" class="email author">email</a> | <?php the_category(', '); ?></span></span> 
